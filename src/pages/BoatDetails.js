...
const BoatDetails = () => {
  ...
  return (
	...
	<div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
		...
		<div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md dark:bg-gray-50">
			<div className="space-y-2">
				<p rel="noopener noreferrer" href="#" className="inline-block text-2xl font-semibold sm:text-3xl text-red-200">{boat.title}</p>
				<p className="text-xs dark:text-gray-600">Rent:
					<p rel="noopener noreferrer" href="#" className="text-xs hover:underline">{boat.price}</p>
				</p>
			</div>
	...
	<div><button className='rounded-xl bg-red-200 hover:bg-red-400 text-slate-600 px-5 lg:px-7 py-2 text-2xl'><Link to=".." relative="path">Back to Menu</Link></button></div>
	</div>
